          ...
          {view === "dashboard" && (
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                <div className="relative p-6 rounded-3xl shadow-md bg-purple-100 text-purple-900 hover:scale-105 transition-all">
                ...
                <div onClick={() => setView("journals")} className="relative p-6 rounded-3xl shadow-md bg-pink-100 text-purple-900 hover:scale-105 transition-all cursor-pointer">
                  <FaSmile className="text-3xl mb-3 text-pink-500" />
                  <h3 className="text-md font-medium">Check-ins</h3>
                ...
                <div className="relative p-6 rounded-3xl shadow-md bg-indigo-100 text-purple-900 hover:scale-105 transition-all">
